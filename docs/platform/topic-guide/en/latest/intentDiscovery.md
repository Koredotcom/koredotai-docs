...
<details open>
 ...
 <a class="nested-accordian-link" target="_blank" href="https://developer.kore.ai/docs/bots/analyzing-your-bot/analyzing-your-bot/">
  ...
  <summary>What is Intent Discovery? 
  </summary>
...
Labels tagged to a conversation help the analyst identify the criticality and the action needed for the bot. On the Intent Discovery dashboard, you can add custom labels to a conversation. You can easily locate the labeled conversations using the Filters options.
